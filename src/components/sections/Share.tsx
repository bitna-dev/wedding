  ...
  const shareKakao = () => {
    window.Kakao.Share.sendDefault({
      ...
      content: {
        ...
        imageUrl:
          'https://media.istockphoto.com/id/1303189272/ko/%EC%82%AC%EC%A7%84/%EC%8B%A0%EB%B6%80%EC%99%80-%EC%8B%A0%EB%9E%91%EC%9D%80-%ED%95%A8%EA%BB%98-%EC%9E%91%EC%9D%80-%EC%86%90%EA%B0%80%EB%9D%BD%EC%9D%84-%EC%82%AC%EC%9A%A9%ED%95%A9%EB%8B%88%EB%8B%A4-%EC%82%AC%EB%9E%91%EC%8A%A4%EB%9F%AC%EC%9A%B4-%EB%B6%80%EB%B6%80%EB%8A%94-%EC%9D%BC%EB%AA%B0-%EB%B0%B0%EA%B2%BD%EC%9C%BC%EB%A1%9C-%EC%86%90%EC%9D%84-%EC%9E%A1%EA%B3%A0.jpg?s=612x612&w=0&k=20&c=L9S4jbzW4wUxHYXXt7_wdH8Qu9XESgyyOHggR9PKrUA=',
        link: {
...
const IconLink = () => {
  return (
    ...
    >
      <path
        d="M11.7057 13.7071L17.9986 7.41421V11H19.9986V4H12.9986V6H16.5844L10.2915 12.2929L11.7057 13.7071Z"
        fill="black"
      />
      <path
        d="M19.0015 18V14H17.0015V18H6.00146V7H10.0015V5H6.00146C4.8969 5 4.00146 5.89543 4.00146 7V18C4.00146 19.1046 4.8969 20 6.00146 20H17.0015C18.106 20 19.0015 19.1046 19.0015 18Z"
        fill="black"
      />
    </svg>
  )
